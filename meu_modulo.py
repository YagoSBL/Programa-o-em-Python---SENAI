def mercado (lista_prod,lista_valores):
    carrinho = []
    meus_valores = []
    per = input('Deseja pedir? ')
    while per == 'sim':
        produto = int(input(f'''
                  1 {lista_prod [1]} - {lista_valores[1]}
                  2 {lista_prod [2]} - {lista_valores[2]}
                  3 {lista_prod [3]} - {lista_valores[3]}
                  4 {lista_prod [4]} - {lista_valores[4]}
                  5 {lista_prod [5]} - {lista_valores[5]}
                  6 {lista_prod [6]} - {lista_valores[6]}
                  '''))
        ...
        print('Se a compra foi efetuada, vá até pagamento ')
